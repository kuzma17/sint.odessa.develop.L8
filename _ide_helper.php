...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function paginate($perPage, $path = null, $total = null, $page = null, $pageName = 'page')
        {
                        return \Illuminate\Support\Collection::paginate($perPage, $path, $total, $page, $pageName);
        }
